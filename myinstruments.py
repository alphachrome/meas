...
class BK8600:
    ...
    def set_cv(self, curr):
        self.instr.write("FUNC VOLT")
        self.instr.write(":SOUR:VOLT:LEV {:.3f}".format(curr))
    def set_cw(self, pwr):
    ...
    def set_func(self, val):
        self.instr.write(":SOUR:FUNC {}".format(val))
    ...
    def status(self):
        print ("IDN = {}".format(self.instr.ask("*IDN?")))
        print ("SENSE = {}".format(self.instr.ask(":REM:SENS?")))
        print ("TRAN = {}".format(self.instr.ask(":TRAN:STAT?")))
        print ("FUNC = {}".format(self.instr.ask(":SOUR:FUNC?")))
